...
export default class Socket extends EventEmitter {
    ...
    setKeepAlive(enable = false, initialDelay = 0) {
        ...
        if (initialDelay !== 0) {
            console.warn(
                'servisofts-socket: initialDelay param in socket.setKeepAlive() is ignored'
            );
        }
    ...
    ref() {
        console.warn('servisofts-socket: TcpSocket.ref() method will have no effect.');
    }

    unref() {
        console.warn('servisofts-socket: TcpSocket.unref() method will have no effect.');
    }
